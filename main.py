...
・タイトル文を「」で囲まないでください
・120文字以内に収めてください
・ネガティブな表現や、以下のネガティブユーザーが好むワードを含めないでください：意味不明、共産主義、中国人、血税、糞尿、悩む、スケベ、低俗、トラブル、酷い、劣等感 など
・以下のカテゴリに該当する話題のみを取り上げてください：物件概要、価格・コスト、交通、構造・建物、共用施設、設備・仕様、間取り、買物・食事、育児・教育、環境・治安、周辺施設
{text}
"""
    payload = {
        "model": "claude-3-haiku-20240307",
